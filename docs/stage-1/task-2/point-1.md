...
- [ ] Конфигурационный файл создан и синтаксически корректен
- [ ] Домен добавлен в /etc/hosts
- [ ] Сайт отвечает на запросы (хотя бы ошибка, но не "connection refused")
- [ ] Логи Nginx не показывают критических ошибок
