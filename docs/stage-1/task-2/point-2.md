...
- [x] PHP 8.4 установлен и работает
- [x] PHP-FPM запущен и слушает порт 9000
- [x] Конфигурация PHP-FPM корректна
- [x] Nginx может обрабатывать PHP файлы через PHP-FPM
- [x] Laravel приложение открывается в браузере
